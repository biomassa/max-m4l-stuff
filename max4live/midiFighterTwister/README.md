...
- according to internet, when loading the device for the first time, you might need to delete and reinsert it. this is due to the way the abstractions are treated in max4live. personally, i have not experienced that, but YMMV
